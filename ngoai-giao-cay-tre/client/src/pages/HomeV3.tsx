      ...
      },
      {
         front: (
            <div className="space-y-4 font-['Times_New_Roman'] text-[#1c0a0a] text-[17px] leading-relaxed text-justify">
               ...
               <p className="indent-10">“Dĩ bất biến ứng vạn biến” là lấy cái không thể thay đổi (bất biến) để ứng phó with muôn sự thay đổi (vạn biến). Theo đó, cái “bất biến” là lợi ích của quốc gia, dân tộc, độc lập dân tộc, chủ quyền... là cốt lõi; cái “vạn biến” là cách ứng phó tài tình, khéo léo, linh hoạt, kết hợp hài hòa giữa mềm dẻo và kiên quyết, giữa chiến lược và sách lược, giữa cương và nhu, giữa chủ động và sáng tạo trong những tình huống cụ thể. Để thực hiện “ứng vạn biến”, điều quan trọng là phải đánh giá đúng tình hình quốc tế và sự tác động đối với nước ta, cả mặt thuận và khó khăn. Hồ Chí Minh chỉ rõ: “Mục đích bất di bất dịch của ta vẫn là hòa bình, thống nhất, độc lập, dân chủ. Nguyên tắc của ta thì phải vững chắc, nhưng sách lược của ta thì linh hoạt”(16).</p>
            </div>
         ),
         back: (
            <div className="space-y-4 font-['Times_New_Roman'] text-[#1c0a0a] text-[17px] leading-relaxed text-justify">
      ...
      <main className="bg-[#080404] text-white w-full h-screen overflow-y-auto snap-y snap-mandatory scroll-smooth relative no-scrollbar">
         ...
         <Section id="Nghiên cứu" className="!p-0 bg-[#080404] overflow-hidden">
            <div className="absolute inset-0 z-0 w-full h-full overflow-hidden">
               ...
               <div className="absolute inset-0 z-10 opacity-[0.4] mix-blend-screen pointer-events-none">
                  <video autoPlay loop muted playsInline className="w-full h-full object-cover filter blur-[1px] scale-110"><source src={codangcovn} type="video/mp4" /></video>
               </div>
         ...
         <Section id="Sự kiện" className="overflow-hidden relative bg-[#0a0505]">
            ...
            <div className="absolute inset-0 z-0">
               ...
               <div className="absolute inset-0 opacity-[0.05] pointer-events-none bg-[url('https://grain-y.com/images/grain.png')] mix-blend-overlay"></div>
            </div>
            ...
            <div className="w-full max-w-7xl mx-auto px-12 lg:px-24 relative z-10 py-24">
               ...
               >
                  <h3 style={{ fontFamily: "'Times New Roman', Times, serif" }} className="text-white text-5xl lg:text-7xl font-black uppercase mb-6 tracking-tight drop-shadow-[0_10px_30px_rgba(185,28,28,0.5)]">SỰ KIỆN ĐỐI NGOẠI NỔI BẬT</h3>
                  <div className="w-48 h-[2px] bg-red-700 mx-auto shadow-[0_0_15px_rgba(185,28,28,0.8)]"></div>
                  <p className="text-white/60 text-[12px] uppercase tracking-[0.5em] mt-10 font-bold italic">QUỐC GIA - DÂN TỘC - ĐỐI NGOẠI</p>
               </motion.div>
               ...
               <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-16">
                  {[
                     ...
                     <motion.div
                        ...
                        className="group relative aspect-[1/1.5] bg-[#1a0808]/60 backdrop-blur-xl border-4 border-red-800 rounded-[2.5rem] overflow-hidden hover:border-red-500 transition-all duration-300 cursor-pointer shadow-[0_50px_100px_rgba(0,0,0,0.8)]"
                     ...
                     >
                        ...
                        {/* TRADITIONAL RED STAMP (MỘC) Overlay - Moves in 3D */}
                        <div className="absolute inset-0 flex items-center justify-center z-20 group-hover:opacity-0 transition-all duration-700 pointer-events-none" style={{ transform: 'translateZ(80px)' }}>
                        ...
                        {/* Red Corner Accents (Bo góc đỏ) - Stays flat on top */}
                        <div className="absolute top-0 left-0 w-24 h-24 border-t-[12px] border-l-[12px] border-red-700 rounded-tl-[2.5rem] opacity-60 z-30 pointer-events-none"></div>
                        <div className="absolute bottom-0 right-0 w-24 h-24 border-b-[12px] border-r-[12px] border-red-700 rounded-br-[2.5rem] opacity-60 z-30 pointer-events-none"></div>

                        {/* Year Badge (Floating) */}
                        <div className="absolute top-10 right-10 bg-[#D4AF37] text-black px-8 py-2 rounded-full font-black text-2xl shadow-[0_10px_30px_rgba(212,175,55,0.4)] z-40" style={{ transform: 'translateZ(120px)' }}>
                           {item.year}
                        </div>
                        ...
                        {/* Active Shine Effect */}
                        <div className="absolute inset-0 w-full h-full pointer-events-none overflow-hidden z-[60]">
                           <div className="absolute top-0 -left-[100%] w-full h-full bg-gradient-to-r from-transparent via-white/20 to-transparent skew-x-[-25deg] group-hover:left-[100%] transition-all duration-1000 ease-in-out"></div>
                        </div>
                     </motion.div>
            ...
            <div className="fixed inset-0 z-[200] bg-black/40 backdrop-blur-2xl flex items-center justify-center p-6 lg:p-24 overflow-hidden" onClick={() => setSelectedImg(null)}>
               ...
               <div className="absolute top-12 right-12 z-[250]">
                  <motion.button
                     ...
                     className="group relative w-24 h-24 flex items-center justify-center focus:outline-none"
                  >
                     {/* Rotating Archive Text Ring */}
                     <svg className="absolute inset-0 w-full h-full animate-[spin_10s_linear_infinity] opacity-20 group-hover:opacity-100 transition-opacity duration-700 pointer-events-none" viewBox="0 0 100 100">
                        <path id="circlePath" d="M 50, 50 m -35, 0 a 35,35 0 1,1 70,0 a 35,35 0 1,1 -70,0" fill="transparent" />
                        <text className="text-[6px] font-black uppercase tracking-[0.4em] fill-[#D4AF37]">
                     ...
                     {/* Floating ESC Label */}
                     <span className="absolute -bottom-4 text-white/20 group-hover:text-[#D4AF37] text-[8px] font-black tracking-[0.8em] transition-all duration-500 uppercase translate-y-2 group-hover:translate-y-0 opacity-0 group-hover:opacity-100">ESC</span>
                  </motion.button>
               </div>
            </div>
         )}
